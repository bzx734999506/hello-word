...
<script type="text/javascript">
	...
	$("#iconUpdate").combobox({
		...
		onChange: function (newValue,oldValue) {
			...
			$('#iconUpdate').combobox('setValue',newValue).combobox('setText',newValue);		
		},
		...
		onClick:function(selectMenu){//selectMenu is the clicked object(json data)
			...
			{
				$('#iconUpdate').combobox('setValue',"").combobox('setText',"");	
				return;
			}
...
<div class="content" align="center">
        <table>
            ...
            <tr>
                ...
                <td><input class="easyui-textbox"  id="accountNo" style="height:25px" disabled /></td>
            </tr>

            <tr>
                <td><span>账户图标 ：</span></td>       
                <td>
                	<input id="iconUpdate" name="iconUpdate" class="easyui-combobox" style="width:100%;"  data-options="
					valueField: 'id',
					textField: 'text',
					data:iconData
					">
