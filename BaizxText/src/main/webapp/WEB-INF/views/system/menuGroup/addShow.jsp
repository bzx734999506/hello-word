...
<script type="text/javascript">
	...
	$("#groupIconAdd").combobox({

		onChange: function (newValue,oldValue) {
			mySelectValue=newValue;
			$('#groupIconAdd').combobox('setValue',newValue).combobox('setText',newValue);		
		},
		...
		onClick:function(selectMenu){//selectMenu is the clicked object(json data)
			...
			{
				$('#groupIconAdd').combobox('setValue',"").combobox('setText',"");	
				return;
			}
...
<div class="content" align="center">
        <table>
            ...
            <tr>
                <td><span>组名称：</span></td>
                <td><input class="easyui-textbox"  id="groupNameAdd" style="height:25px" /></td>
            </tr>

            <tr>
                <td><span>组图标 ：</span></td>       
                <td>
                	<input id="groupIconAdd" name="groupIconAdd" class="easyui-combobox" style=""  data-options="
					valueField: 'id',
					textField: 'text',
					data:iconData
					">
