...
<script type="text/javascript">
	...
	$("#groupIconUpdate").combobox({

		onChange: function (newValue,oldValue) {
// 			console.log(newValue);
// 			console.log(oldValue);
			mySelectValue=newValue;
			$('#groupIconUpdate').combobox('setValue',newValue).combobox('setText',newValue);		
		},
		...
		onClick:function(selectMenu){//selectMenu is the clicked object(json data)
			...
			{
				$('#groupIconUpdate').combobox('setValue',"").combobox('setText',"");	
				return;
			}
...
<div class="content" align="center">
        <table>
            ...
            <tr>
                <td><span>菜单名：</span></td>
                <td><input class="easyui-textbox"  id="groupNameUpdate" style="height:25px" /></td>
            </tr>
            ...
            <tr>
                ...
                <td>
                	<input id="groupIconUpdate" name="groupIconUpdate" class="easyui-combobox" style=""  data-options="
					valueField: 'id',
					textField: 'text',
					data:iconData
					">
