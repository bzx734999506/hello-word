...
<script type="text/javascript">
	...
	$("#menuIconUpdate").combobox({

		onChange: function (newValue,oldValue) {
// 			console.log(newValue);
// 			console.log(oldValue);
			mySelectValue=newValue;
			$('#menuIconUpdate').combobox('setValue',newValue).combobox('setText',newValue);		
		},
		...
		onClick:function(selectMenu){//selectMenu is the clicked object(json data)
			...
			{
				$('#menuIconUpdate').combobox('setValue',"").combobox('setText',"");	
				return;
			}
...
<div class="content" align="center">
        <table>
            ...
            <tr>
                <td><span>菜单名：</span></td>
                <td><input class="easyui-textbox"  id="menuNameUpdate" style="height:25px" /></td>
            </tr>
 
            <tr>
                <td><span>菜单URL ：</span></td>       
                <td><input class='easyui-textbox' id="urlUpdate" style="height:25px" /></td>
            </tr>
            <tr>
                <td><span>菜单图标 ：</span></td>       
                <td>
                	<input id="menuIconUpdate" name="menuIconUpdate" class="easyui-combobox" style=""  data-options="
					valueField: 'id',
					textField: 'text',
					data:iconData
					">
            ...
            <tr>
                ...
                <td>
                	<input id="needAuthFlagUpdate" name="needAuthFlagUpdate" class="easyui-combobox" style=""  data-options="
					valueField: 'value',
					textField: 'text',
					data:authData
					">
            ...
            <tr>
                ...
                <td>
                	<input id="menuFlagUpdate" name="menuFlagUpdate" class="easyui-combobox" style=""  data-options="
					valueField: 'value',
					textField: 'text',
