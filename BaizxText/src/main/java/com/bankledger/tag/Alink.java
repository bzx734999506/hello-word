...
public class Alink extends TagSupport {
	...
	public String getATagString(){
		StringBuffer aLink=new StringBuffer("<a href=\"#\" ");
		addAttribute(aLink,"url",url);	
		addAttribute(aLink,"style",style);
		addAttribute(aLink,"class",cssClass);
		addAttribute(aLink,"id",id);
		addAttribute(aLink,"onclick",onclick);
		aLink.append(">"+name+"</a>");		
